...
Codex and Claude Code both use the adjacent `.mcp.json` connection. The registered Adagio OpenAI app belongs to the separately reviewed official listing and is deliberately not mapped by this GitHub fallback package. The MCP descriptor contains no credentials.
